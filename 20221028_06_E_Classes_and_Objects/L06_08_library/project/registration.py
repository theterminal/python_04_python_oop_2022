# from project.user import User               # When working in main project directory uncomment this line
# from project.library import Library         # When working in main project directory uncomment this line

from user import User                         # When working in main project directory comment out this line
from library import Library                   # When working in main project directory comment out this line
...
class Registration:
    ...
    def change_username(self, user_id: int, new_username: str, library: Library):
        try:
            usr = next(filter(lambda x: x.user_id == user_id, library.user_records))
        ...
        if usr.username in library.rented_books:
            library.rented_books[new_username] = library.rented_books[usr.username]
            del library.rented_books[usr.username]
...
print('\n_______ Test Code 2 _________________\n')
