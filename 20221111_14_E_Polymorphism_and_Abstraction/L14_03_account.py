...
# 03 - Account - judge url: https://judge.softuni.org/Contests/Compete/Index/1943#2
...
class Account:
    ...
    def add_transaction(self, amount: int):
        ...
        return self.handle_transaction(amount)                      # return it so you get the message of 'new balance'
